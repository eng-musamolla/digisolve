    ...
    <footer className="footer footer-center p-10 bg-base-200 text-base-content rounded">
      ...
      <nav>
        <div className="grid grid-flow-col gap-4">
          <a
            aria-label="SocialMedia Link for digisolve"
            target="_blank"
            href=" https://www.youtube.com/@digisolve-com-bd"
          >
            <svg
              width="24"
              height="24"
          ...
          <a
            aria-label="SocialMedia Link for digisolve"
            target="_blank"
            href="https://www.facebook.com/digisolve.com.bd"
          >
            <svg
              width="24"
              height="24"
          ...
          <a
            aria-label="SocialMedia Link for digisolve"
            target="_blank"
            href="https://www.instagram.com/digisolve.com.bd/"
          >
            <svg
              viewBox="0 0 50 50"
              width="24"
          ...
          <a
            aria-label="SocialMedia Link for digisolve"
            target="_blank"
            href="https://www.tiktok.com/@digisolve.com.bd"
          >
            <svg
              viewBox="0 0 50 50"
              width="24"
            ...
            <div className="flex flex-row justify-center items-start sm:items-center">
              <div className="flex items-center text-center">
                <span className="text-xs">
                  Copyright © 2024 - All right reserved by DigiSolve
                </span>
              </div>
            </div>
